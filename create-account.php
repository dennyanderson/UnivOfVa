...
<html lang="en">
  ...
  <body>
	...
	<div class="container" id="left">
	  ...
	  <input id="computing-id" name="computing-id" type="text" required maxlength="10"/><br>
	  <label for="first"><strong>First Name</strong></label><br>
	  <input id="first" name="first" type="text" required maxlength="20"/><br>
	  <label for="last"><strong>Last Name</strong></label><br>
	  <input id="last" name="last" type="text" required maxlength="20"/><br>
	  <label for="password"><strong>Password</strong></label><br>
	  <input id="password" name="password" type="password" required maxlength="128"/><br>
	</div>
	...
	<button type="submit" id="click" name="cmd" value="create"><strong>Create Account</strong></button>
      </form>
      <p>&nbsp</p>
      <p>&nbsp</p>
      <p>&nbsp</p>
