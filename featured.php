...
<html lang="en">
  ...
  <body>
    <div class="bg">
      <header>
        <h1><strong>Classes You Might Like</strong></h1>
	  ...
	  <li role="presentation" class="active"><a href="featured.php" id="featured"><span class="glyphicon glyphicon-tasks" aria-hidden="true"></span>&nbspFeatured</a></li>
	...
	<table class="table" id="table">
	  <thead>
	    <tr>
	      <th id="className" scope="col">Class Name</th>
	      <th id="percentMatch" scope="col">Percent Match</th>
	    </tr>
	  </thead>
	  <tbody id="classTable">
	  </tbody>
